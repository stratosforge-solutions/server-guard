...
define("interface", default="0.0.0.0", help="interface")
...
server = maproxy.proxyserver.ProxyServer("http://www.http2demo.io",80,session_factory=LoggingSessionFactory())
server.listen(8100)
print("http://127.0.0.1:8100 -> http://localhost")    
